...
function calculateM(p:number, r:number, n:number) {
    let mr = (r/100)/12;
...
// Lägger till händelse för knappen
  submitbtB.addEventListener("click",function (){
    lon = document.getElementById("lon").value as HTMLInputElement;
    renta = document.getElementById("renta").value as HTMLInputElement;
    time = document.getElementById("time").value as HTMLInputElement;
